...
var followingURL = "https://api.github.com/users/mralexgray/following";    
    
var $repoTable = $('#repoTable');
var $followers = $('#followersSelection');
var $following = $('#followingSelection');
var $loader = $('#loader');
var $followerDetails = $('#followersDetails');
...
fetchData(followingURL, $loader, "Following List", $following);    
    
$followers.change(function() {
    var $activitiesURL = "https://api.github.com/users/"+$( "#followersSelection option:selected" ).text()+"/received_events";
    fetchData($activitiesURL, $loader, "Activities List", $followerDetails);
});

$following.change(function() {
    var $activitiesURL = "https://api.github.com/users/"+$( "#followingSelection option:selected" ).text()+"/received_events";
    fetchData($activitiesURL, $loader, "Activities List", $followingDetails); 
});    
